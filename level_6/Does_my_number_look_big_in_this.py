...
to the power of the number of digits in a given base. For example, take 153 (3 digits), which is narcissistic:
...
def narcissistic(value):
    digits = str(value)
    return sum(int(digit) ** len(digits) for digit in digits) == value
