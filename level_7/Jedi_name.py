# They need you to write a function, greet_jedi(), which takes two arguments (a first name and a last name),
# works out the corresponding Jedi name, and returns a string greeting the Jedi. A person's Jedi name is the
# first three letters of their last name followed by the first two letters of their first name.
...
def greet_jedi(first, last):
    ...
    return  f'Greetings, master {last[::3]} {first[::2]}'